...
public class NonExactSolution {
    ...
    public static void main(String[] args) {
       ...
       FileWriter writer;
            try{
                writer = new FileWriter("C:\\Users\\zaphk\\Desktop\\Non-ExactSolution-master\\time.txt" , true);
        ...
        FileWriter writer2;
        try{
            writer2 = new FileWriter("C:\\Users\\zaphk\\Desktop\\Non-ExactSolution-master\\cliqueResult.txt" , true);
    ...
    private static int[] getUserInput() {
        ...
        } while(isNumberValid(line, 10, 30) == false);
        ...
        while(isNumberValid(line, 10, graphSize) == false);
